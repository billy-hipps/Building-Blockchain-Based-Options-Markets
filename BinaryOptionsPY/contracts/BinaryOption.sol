...
contract BinaryOption {
    ...
    constructor() {
        ...
        name = "AAPL_BO";
        decimals = 18;
        _totalSupply = 1_000_000_000_000_000; //1 contract with 15 zeros of decimal points 
        // strikePrice = 224;
        // strikeDate = 10 days;
        // payOff = 5 gwei;
        ...
        balances[0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266] = _totalSupply; // balance of my wallet is total supply (i am the creator)
        emit Transfer(address(0), 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266, _totalSupply); // any transfer will originate from my wallet? 
    }
